package com.mane.test2mod.worldgen.portal;

import com.mane.test2mod.block.ModBlocks;
import com.mane.test2mod.block.custom.TestPortalBlock;
...
public class TestTeleporter implements ITeleporter
{
    ...
    public TestTeleporter(BlockPos pos, boolean insideDim) {
        thisPos = pos;
    ...
    public Entity placeEntity(Entity entity, ServerLevel currentWorld, ServerLevel destinationWorld,
        ...
        if (insideDimension) {
            ...
            if (doSetBlock) {
                destinationWorld.setBlock(destinationPos, ModBlocks.TEST_PORTAL.get().defaultBlockState(), 3);
            }
        }
